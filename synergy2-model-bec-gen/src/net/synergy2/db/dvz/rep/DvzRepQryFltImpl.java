...
public class DvzRepQryFltImpl extends DvzRepQryFlt {

    protected DvzRepQryFltImpl () { super (); }

    public enum DvzRepQryFltFields implements ISField {
        Uid, RepQryUid, FltSrt, FltUsr, FltTyp, OprLog, OprAri, FltTblAls, FltColUid, FltOpr, Val, ValTblAls, ValColUid, ValRepQryUid, Tsi, Tsu, Rsi, Rsu;
    } // DvzRepQryFltFields
    
    private static String baseUrl = "/rest/dvz/rep/DvzRepQryFlt";


    @Override public String getModelClassName () { return "DvzRepQryFltImpl"; }
    ...
    @Override public String debug (boolean full, boolean cascade, String indent) {
        ...
        str.append ("FltUsr[").append (getFltUsr ()).append ("] ");
    ...
    @Override public DvzRepQryFltImpl newEmptyInstance () { return (DvzRepQryFltImpl) newInstance (); }
    
    @Override public DvzRepQryFltImpl getCopy () {
        return (DvzRepQryFltImpl) super.getCopy ();
    } // getCopy
    
    public boolean equals (DvzRepQryFlt _other, boolean checkUid, boolean checkCod, boolean checkCommon) {
    ...
    */
    ...
    @Override public String getBaseUrl () { return DvzRepQryFltImpl.baseUrl (); }
    public static String baseUrl () { return DvzRepQryFltImpl.baseUrl; }
    @Override public void setBaseUrl (String baseUrl) { DvzRepQryFltImpl.baseUrl = baseUrl; } 

    @Override public List<DvzRepQryFltFields> getFields () { return Arrays.asList (DvzRepQryFltFields.values ()); }
