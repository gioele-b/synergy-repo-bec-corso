...
public class AngCalEvtClsRefImpl extends AngCalEvtClsRef {

    protected AngCalEvtClsRefImpl () { super (); }

    public enum AngCalEvtClsRefFields implements ISField {
        Uid, ClsUid, ClsRefUid, Tsi, Tsu, Rsi, Rsu;
    } // AngCalEvtClsRefFields
    
    private static String baseUrl = "/rest/sys/cal/AngCalEvtClsRef";


    @Override public String getModelClassName () { return "AngCalEvtClsRefImpl"; }
    ...
    @Override public AngCalEvtClsRefImpl newEmptyInstance () { return (AngCalEvtClsRefImpl) newInstance (); }
    
    @Override public AngCalEvtClsRefImpl getCopy () {
        return (AngCalEvtClsRefImpl) super.getCopy ();
    } // getCopy
    
    public boolean equals (AngCalEvtClsRef _other, boolean checkUid, boolean checkCod, boolean checkCommon) {
    ...
    */
    ...
    @Override public String getBaseUrl () { return AngCalEvtClsRefImpl.baseUrl (); }
    public static String baseUrl () { return AngCalEvtClsRefImpl.baseUrl; }
    @Override public void setBaseUrl (String baseUrl) { AngCalEvtClsRefImpl.baseUrl = baseUrl; } 

    @Override public List<AngCalEvtClsRefFields> getFields () { return Arrays.asList (AngCalEvtClsRefFields.values ()); }
