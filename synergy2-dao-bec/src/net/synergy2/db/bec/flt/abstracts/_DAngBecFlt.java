...
public abstract class _DAngBecFlt extends TableDao<AngBecFlt> implements UserFieldsDao<AngBecFlt> {

    private static class Singleton {
        private static final SSingletonHolder<_DAngBecFlt> runtime = new SSingletonHolder<> ("net.synergy2.db.bec.flt.AngBecFltDao");
    } // Singleton
    
    public static _DAngBecFlt get () {
        return Singleton.runtime.get ();
    } // get

    @Override public String getTableName () { return "AngBecFlt"; }

    protected static final String SQL_SEQUENCE = "SBecFlt001";

    
    @Override
    public AngBecFlt newInstance () {
        return AngBecFlt.newInstance ();
    } // newInstance
     ...
     * @throws SSqlException In caso di errore SQL.
     */
    public AngBecFlt getById (final long uid, final ExecutionContext context, final SReadCon rCon) throws SConnectionException, SSqlException, SModelNullException {
     ...
     * @throws SSqlException In caso di errore SQL.
     */ 
    public AngBecFlt getByCode (final String becFltCod, final ExecutionContext context, final SReadCon rCon) throws SConnectionException, SSqlException {
        var model = newInstance ();
        model.setBecFltCod (becFltCod);
     ...
     */
    public void checkCode (final String becFltCod, Long uid, final ExecutionContext context, final SReadCon rCon) throws SConnectionException, SSqlException, SCodeExistsException, SModelNullException {
        var model = newInstance ();
        model.setBecFltCod (becFltCod);
        model.setUid (uid);
     ...
     * @throws SCodeExistsException In caso di codice gia' presente.
     */
    public void checkCode (final String becFltCod, ExecutionContext context, SReadCon rCon) throws SConnectionException, SSqlException, SCodeExistsException, SModelNullException {
        checkCode (becFltCod, null, context, rCon);
    } // checkCode
     ...
     */
    public AngBecFlt safeAutoUpdateInsert (final AngBecFlt model, final ExecutionContext context, final SWriteCon wCon) throws SModelNullException, SConnectionException, SSqlException, SCodeExistsException, SAuditException, SIdExistsException, SNotLastVersionException, SIdNullException, SModelValidationException {
    ...
    public String getSqlSequence () {
        return _DAngBecFlt.SQL_SEQUENCE;
    } // getSqlSequence
